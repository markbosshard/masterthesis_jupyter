...
define([
  ...
  initWizardSteps = function() {
      ...
      var s3dt = "Here you will assign the actions to the assignments. First drag the new assignment button to create new assignment. "+
      ...
      " Now you can add the dependencies by adding the arrows between the assignment and then drag the milestone button to add the milestones to your project." +
      " Do remember to double click on the buttons to rename."
      $("#master-wizard").steps('add', {
        title: "Assignments",
