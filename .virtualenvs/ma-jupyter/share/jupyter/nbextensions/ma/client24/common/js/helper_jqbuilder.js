...
define(['exports',
  ...
  exports.wizard.assignmentContainer = function() {
    ...
    var assignmentDetails = $('<div/>', {id: 'assignmentDetails', class: "mining-step clearfix large step3", style: "height: 150px; width:100%; overflow: hidden"});

    $(arr).append(flowchartSelector);
    $(arr).append(flowchartPane);
    $(arr).append(milestoneFlowchart);
  ...
  exports.project.display= function(jsonobj) {
	...
	//$(pre_left).append(f_picon('fa-lg fa-link',jsonobj['next']));
