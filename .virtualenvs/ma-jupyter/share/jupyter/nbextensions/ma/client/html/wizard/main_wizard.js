...
var next = $('<div/>').append(
	...
	Form genrattion and Action select
        */
	var template_url=gdapi.templateurl();
	
	
	var template="<div><a href="+template_url+">Click here to add questions</a></div>";
	...
	var c2w = $('<div/>',{class: 'ques-step-right'}).append(template,
    ...
    var c2 = $('<div/>', {class: 'stepcontent'}).append(c2l,c2w);
      ...
      $("#master-wizard").steps('add', {
		...
		var Body="Hello, You have been selected to play a role as a worker in Collaborative Data Analysis. You will Shortly receive the workpackage as a shared Google drive folder from our Data Scientist. To receive the workpakage, please click on the link to answer few basic interview questions. You can communicate with him using the respective email id. Thank you!."
