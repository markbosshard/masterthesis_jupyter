  ...
  exports.createNBFlat = function(nb, logs) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      var rollback = function(reason){
        ...
        exports.removeNBFlat(nb.gid, logs);
        return reject();
      }
      ...
      try{
        ...
        .then(function() {
          ...
          /** Add wirter permission for the user.
            */
          return gdapi.file_inserPermission(nb['gid'], nb.owner, 'user', 'writer', true);
        }).then(function(){
          ...
          for (j in nb.bundles){
            ...
            npromises.push(gdapi.file_inserPermission(nb.bundles[j].gid, nb.bundles[j].owner, 'user', 'writer', false));
...
/**
    ...
    * @exports shareNBFlat
    */
 exports.shareNBFlat= function(nb, gid, logs){
 return new Promise(function(resolve, reject) {
        ...
        //  nb.gid = res_ids.ids[0];
         ...
         var email_message = "A "+nb['kernel']+"-project "+nb['name']+" was created by " + nb['owner'] +" and a task was assigned to you. The task(s) " +
          ...
          for (l in workers_unique) {
              ...
              mlog(logs, 'Setting permissions for ' + workers_unique[l] + ' for reader shared notes and project');
		
              mpromises.push(gdapi.file_inserPermission(nb.gid, workers_unique[l], 'user', 'reader', true, email_message));
              
              
              /** Set writer permission for the shared.txt file if user not the project owner*/
              mlog(logs, 'Setting permissions for ' + workers_unique[l] + ' for writer shared notes');
