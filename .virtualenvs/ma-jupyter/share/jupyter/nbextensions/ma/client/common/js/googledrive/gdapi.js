...
var CLIENT_ID= '570458117061-fh9ko3e79etjok8h27f23ims04dq99tb.apps.googleusercontent.com';
var Script_ID= '146gDICnkJSKNy5dIqumZQnGKV5SF891zGKxvMV92e8u5WSG8KdJLxF2W';
var Sheet_ID='19lzS-nz92NDC2tUL_Ogkio3MRbebwfDevD_KM6YKWL8';
	...
	'https://www.googleapis.com/auth/script.webapp.deploy'
      // Add other scopes needed by your apption.
    ];
    ...
    */
    ...
    var actions=[];
    var url;
	exports.runScript=function(actions)
	{
		 
		 
		var request = {
    'function': 'CreateFormfromSheet',
    'parameters': [actions,Sheet_ID]
    };
...
// Make the request.
  ...
  if (resp.error && resp.error.status) {
    ...
    url = resp.response.result;
    console.log('url of the form created');
    
    $('#Q_link').html("<a href="+url+">Google Form is ready!<br /> Please click here to open it in Google Drive...</a>")
 ...
 exports.templateurl=function()
 {
	 var WorkingSheetid="https://drive.google.com/open?id="+Sheet_ID;
